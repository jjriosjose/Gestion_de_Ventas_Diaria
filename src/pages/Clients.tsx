...
export function Clients() {
  ...
  const canAssign = employee?.app_role === 'Administrador' || employee?.app_role === 'Supervisor'
  ...
  return <div className="page-stack">
    ...
    {edit && <EditClient client={edit} employees={employees} canAssign={canAssign} onClose={() => setEdit(null)} onSaved={() => { setEdit(null); void load() }}/>} 
  </div>
}
...
function EditClient({ client, employees, canAssign, onClose, onSaved }: { client: Client; employees: Employee[]; canAssign: boolean; onClose: () => void; onSaved: () => void }) {
