...
export function ReceptionV2(){
 const {employee}=useAuth();const navigate=useNavigate();const canCreateProspect=hasPermission(employee,'capture.create');const canManageReception=hasPermission(employee,'reception.manage')
