...
export function ReceptionV2(){
 ...
 const visibleAgenda=useMemo(()=>appointmentScope.filter(row=>{
  const key=dateKeyOf(appointmentDate(row));if(from&&key<from)return false;if(to&&key>to)return false
