...
import { Camera, CheckCircle2, FileText, LoaderCircle, MapPin, PackageCheck, RefreshCw, Search, Signature, Truck, UserRound } from 'lucide-react'
...
export function DeliveryHistory() {
  ...
  return <div className="page-stack logistics-page">
    <div className="page-head"><div><span className="eyebrow">LOGÍSTICA · TRAZABILIDAD</span><h2>Historial y POD</h2><p>Busca factura, pedido, cliente, viaje, chofer o placa y consulta la evidencia de entrega.</p></div><button className="secondary" onClick={() => void load()}><RefreshCw size={16}/>Actualizar</button></div>
