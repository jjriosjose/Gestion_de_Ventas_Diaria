...
const baseSteps:TourStep[]=[
  ...
  {id:'quality',path:'/calidad-datos',target:'.content .page-head',eyebrow:'13 · CALIDAD GEOGRÁFICA',title:'Detecta diferencias sin detener la operación',body:'La app compara el registro GPS con la ubicación maestra del cliente. Las anomalías se conservan para auditoría y no bloquean automáticamente la gestión.'},
  {id:'reports',path:'/reportes',target:'.content .page-head',eyebrow:'14 · INTELIGENCIA',title:'De la ejecución a la decisión',body:'Reportes y métricas convierten la actividad diaria en información de cobertura, productividad y seguimiento para supervisión y gestión.'},
