...
begin
  ...
  -- El guard histórico de route_sessions exige que el plan esté PLANIFICADA
  -- justo al crear la sesión. Se respeta ese mismo flujo y solo después se
  -- promueve el contenedor operativo a ACTIVA.
